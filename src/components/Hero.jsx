...
export default function Hero() {
  return (
    ...
    px-6 md:px-16 lg:px-24 xl:px-32
     ...
     <p 
     className="bg-[#49B9FF]/50 px-3.5 py-2 rounded-full mt-20">The Ultimate Hotel Experience</p>
     <h1 className='font-Playfair 
     text-2xl pt-5 md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4  '>Discover Your Perfect Gatway Destnation</h1>
     ...
     <form className='bg-white text-gray-500 rounded-lg px-6 py-4 mt-8 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
            ...
            <div>
                <div className='flex items-center gap-2'>
                    <img src={assets.calenderIcon} className='h-4'></img>
