...
export default function Testimonial() {
  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 pt-20 pb-30'>
      <Title title="What Our Gustes Say" subTitle="Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laborum numquam, mollitia vitae maxime exercitationem illo qui adipisci consectetur repudiandae? Obcaecati, blanditiis accusamus? Fugit debitis in velit dignissimos vero. Laborum, mollitia!"/>
